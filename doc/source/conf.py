# -*- coding: utf-8 -*-
#
# xquic documentation build configuration file, created by
...
extensions = ['sphinx.ext.coverage', 'breathe']
...
latex_documents = [
  ('index', 'xquic.tex', u'xquic Documentation',
   u'岁一', 'manual'),
]
...
man_pages = [
    ('index', 'xquic', u'xquic Documentation',
     [u'岁一'], 1)
]
...
texinfo_documents = [
  ('index', 'xquic', u'xquic Documentation',
   u'岁一', 'xquic', 'One line description of project.',
   'Miscellaneous'),
]
