...
xqc_h3_request_destroy(xqc_h3_request_t *h3_request)
{
    ...
    xqc_log(h3_request->h3_stream->log, XQC_LOG_REPORT, "|stream_id:%ui|close_msg:%s|err:%d"
            ...
            "is_fec_protected:%ud|fec_reco_pkt_cnt:%ud|",
            ...
            h3s->end_trans_state,
            stats.is_fec_protected, stats.fec_recov_cnt);
...
xqc_h3_request_get_stats(xqc_h3_request_t *h3_request)
{
    ...
    stats.is_fec_protected = h3_request->h3_stream->h3c->conn->conn_settings.fec_params.fec_encoder_scheme != 0 ? 1 : 0;
