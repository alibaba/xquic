...
/*
 * Frame type bitmask flags.  Use uint64_t instead of enum because the
 * number of frame types (34) exceeds 32, which would overflow the int
 * backing type that C mandates for enums on most compilers.
 */
typedef uint64_t xqc_frame_type_bit_t;

#define XQC_FRAME_BIT_PADDING \
    (1ULL << XQC_FRAME_PADDING)
#define XQC_FRAME_BIT_PING \
    (1ULL << XQC_FRAME_PING)
#define XQC_FRAME_BIT_ACK \
    (1ULL << XQC_FRAME_ACK)
...
#define XQC_FRAME_BIT_CRYPTO \
    (1ULL << XQC_FRAME_CRYPTO)
#define XQC_FRAME_BIT_NEW_TOKEN \
    (1ULL << XQC_FRAME_NEW_TOKEN)
#define XQC_FRAME_BIT_STREAM \
    (1ULL << XQC_FRAME_STREAM)
#define XQC_FRAME_BIT_MAX_DATA \
    (1ULL << XQC_FRAME_MAX_DATA)
#define XQC_FRAME_BIT_MAX_STREAM_DATA \
    (1ULL << XQC_FRAME_MAX_STREAM_DATA)
#define XQC_FRAME_BIT_MAX_STREAMS \
    (1ULL << XQC_FRAME_MAX_STREAMS)
#define XQC_FRAME_BIT_DATA_BLOCKED \
    (1ULL << XQC_FRAME_DATA_BLOCKED)
#define XQC_FRAME_BIT_STREAM_DATA_BLOCKED \
    (1ULL << XQC_FRAME_STREAM_DATA_BLOCKED)
#define XQC_FRAME_BIT_STREAMS_BLOCKED \
    (1ULL << XQC_FRAME_STREAMS_BLOCKED)
#define XQC_FRAME_BIT_NEW_CONNECTION_ID \
    (1ULL << XQC_FRAME_NEW_CONNECTION_ID)
#define XQC_FRAME_BIT_RETIRE_CONNECTION_ID \
    (1ULL << XQC_FRAME_RETIRE_CONNECTION_ID)
#define XQC_FRAME_BIT_PATH_CHALLENGE \
    (1ULL << XQC_FRAME_PATH_CHALLENGE)
#define XQC_FRAME_BIT_PATH_RESPONSE \
    (1ULL << XQC_FRAME_PATH_RESPONSE)
#define XQC_FRAME_BIT_CONNECTION_CLOSE \
    (1ULL << XQC_FRAME_CONNECTION_CLOSE)
#define XQC_FRAME_BIT_HANDSHAKE_DONE \
    (1ULL << XQC_FRAME_HANDSHAKE_DONE)
#define XQC_FRAME_BIT_ACK_MP \
    (1ULL << XQC_FRAME_ACK_MP)
#define XQC_FRAME_BIT_PATH_ABANDON \
    (1ULL << XQC_FRAME_PATH_ABANDON)
#define XQC_FRAME_BIT_PATH_STATUS \
    (1ULL << XQC_FRAME_PATH_STATUS)
#define XQC_FRAME_BIT_PATH_STANDBY \
    (1ULL << XQC_FRAME_PATH_STANDBY)
#define XQC_FRAME_BIT_PATH_AVAILABLE \
    (1ULL << XQC_FRAME_PATH_AVAILABLE)
#define XQC_FRAME_BIT_MP_NEW_CONNECTION_ID \
    (1ULL << XQC_FRAME_MP_NEW_CONNECTION_ID)
#define XQC_FRAME_BIT_MP_RETIRE_CONNECTION_ID \
    (1ULL << XQC_FRAME_MP_RETIRE_CONNECTION_ID)
#define XQC_FRAME_BIT_MAX_PATH_ID \
    (1ULL << XQC_FRAME_MAX_PATH_ID)
#define XQC_FRAME_BIT_PATH_FROZEN \
    (1ULL << XQC_FRAME_PATH_FROZEN)
#define XQC_FRAME_BIT_DATAGRAM \
    (1ULL << XQC_FRAME_DATAGRAM)
#define XQC_FRAME_BIT_EXTENSION \
    (1ULL << XQC_FRAME_Extension)
#define XQC_FRAME_BIT_SID \
    (1ULL << XQC_FRAME_SID)
