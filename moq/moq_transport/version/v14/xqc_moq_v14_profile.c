...
static const xqc_moq_message_codec_entry_t xqc_moq_v14_setup_codecs[] = {
    {
...
const xqc_moq_version_profile_t xqc_moq_v14_profile_definition = {
    ...
    .control_codecs = xqc_moq_v14_setup_codecs,
    .control_codecs_count = sizeof(xqc_moq_v14_setup_codecs)
                            / sizeof(xqc_moq_v14_setup_codecs[0]),
};
