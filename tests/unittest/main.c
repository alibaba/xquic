...
main()
{
    ...
    if (!CU_add_test(pSuite, "xqc_test_get_random", xqc_test_get_random)
        ...
        || !CU_add_test(pSuite, "xqc_test_h3_data_headers_on_control_rejected", xqc_test_h3_data_headers_on_control_rejected)
        || !CU_add_test(pSuite, "xqc_test_h3_settings_on_request_rejected", xqc_test_h3_settings_on_request_rejected)
