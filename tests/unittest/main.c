...
main()
{
    ...
    if (!CU_add_test(pSuite, "xqc_test_get_random", xqc_test_get_random)
        ...
        || !CU_add_test(pSuite, "xqc_test_reset_stream_at_reliable_prefix_read", xqc_test_reset_stream_at_reliable_prefix_read)
        || !CU_add_test(pSuite, "xqc_test_reset_stream_at_late_reliable_prefix_read", xqc_test_reset_stream_at_late_reliable_prefix_read)
