...
xqc_int_t
xqc_wt_echo_client_init(xqc_engine_t *engine, int draft_version,
...
xqc_int_t
xqc_wt_echo_client_open(xqc_h3_conn_t *h3_conn,
...
int
xqc_wt_echo_client_finish(void)
{
...
xqc_int_t
xqc_wt_echo_client_conn_closing(xqc_connection_t *conn,
