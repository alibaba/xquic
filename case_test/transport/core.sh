...
case_test_case "log_switch_off" --id legacy --mode self-reporting --run case_transport_core_log_switch_off
case_test_case "server_refuse" --id legacy --mode self-reporting --run case_transport_core_server_refuse
case_test_case "create_connection_fail" --id legacy --mode self-reporting --run case_transport_core_create_connection_fail
case_test_case "socket_recv_fail" --id legacy --mode self-reporting --run case_transport_core_socket_recv_fail
case_test_case "socket_send_fail" --id legacy --mode self-reporting --run case_transport_core_socket_send_fail
case_test_case "verify_token_fail" --id legacy --mode self-reporting --run case_transport_core_verify_token_fail
case_test_case "verify_token_success" --id legacy --mode self-reporting --run case_transport_core_verify_token_success
case_test_case "test_application_delay" --id legacy --mode self-reporting --run case_transport_core_test_application_delay
case_test_case "user_close_connection" --id legacy --mode self-reporting --run case_transport_core_user_close_connection
case_test_case "close_connection_with_error" --id legacy --mode self-reporting --run case_transport_core_close_connection_with_error
case_test_case "transport_ping" --id legacy --mode self-reporting --run case_transport_core_transport_ping
case_test_case "transport_only" --id legacy --mode self-reporting --run case_transport_core_transport_only
case_test_case "transport_0RTT" --id legacy --mode self-reporting --run case_transport_core_transport_0RTT
case_test_case "server_cid_negotiate" --id legacy --mode self-reporting --run case_transport_core_server_cid_negotiate
case_test_case "active_cid_limit_accept" --id legacy --mode self-reporting --run case_transport_core_active_cid_limit_accept
...
case_test_case "server_amplification_limit" --id legacy --mode self-reporting --run case_transport_core_server_amplification_limit
case_test_case "version_negotiation" --id legacy --mode self-reporting --run case_transport_core_version_negotiation
case_test_case "version_negotiation_abort_path" --id legacy --mode self-reporting --run case_transport_core_version_negotiation_abort_path
case_test_case "version_negotiation_close_errno" --id legacy --mode self-reporting --run case_transport_core_version_negotiation_close_errno
case_test_case "server_refuse_connection" --id legacy --mode self-reporting --run case_transport_core_server_refuse_connection
case_test_case "linger_close_transport" --id legacy --mode self-reporting --run case_transport_core_linger_close_transport
case_test_case "linger_close_h3" --id legacy --mode self-reporting --run case_transport_core_linger_close_h3
case_test_case "stateless_reset" --id legacy --mode self-reporting --run case_transport_core_stateless_reset
case_test_case "stateless_reset_during_hsk" --id legacy --mode self-reporting --run case_transport_core_stateless_reset_during_hsk
case_test_case "0rtt_forbidden_remembered_params_normal" --id legacy --mode self-reporting --run case_transport_core__0rtt_forbidden_remembered_params_normal
case_test_case "0rtt_forbidden_remembered_params_stale_not_used" --id legacy --mode self-reporting --run case_transport_core__0rtt_forbidden_remembered_params_stale_not_used
case_test_case "check_clear_0rtt_ticket_flag_in_close_notify" --id legacy --mode self-reporting --run case_transport_core_check_clear_0rtt_ticket_flag_in_close_notify
case_test_case "check_clear_0rtt_ticket_flag_in_h3_close_notify" --id legacy --mode self-reporting --run case_transport_core_check_clear_0rtt_ticket_flag_in_h3_close_notify
case_test_case "request_closing_notify" --id legacy --mode self-reporting --run case_transport_core_request_closing_notify
case_test_case "transport_MP_ping" --id legacy --mode self-reporting --run case_transport_core_transport_MP_ping
case_test_case "0RTT_param_reduction" --id legacy --mode self-reporting --run case_transport_core__0RTT_param_reduction
case_test_case "0RTT_rejected_param_reduction" --id legacy --mode self-reporting --run case_transport_core__0RTT_rejected_param_reduction
