...
case_test_case "datagram_frame_size_negotiation" --id legacy --mode self-reporting --run case_transport_datagram_datagram_frame_size_negotiation
case_test_case "0rtt_max_datagram_frame_size_is_valid" --id legacy --mode self-reporting --run case_transport_datagram__0rtt_max_datagram_frame_size_is_valid
case_test_case "0rtt_max_datagram_frame_size_is_invalid" --id legacy --mode self-reporting --run case_transport_datagram__0rtt_max_datagram_frame_size_is_invalid
case_test_case "datagram_get_mss_no_saved_transport_params" --id legacy --mode self-reporting --run case_transport_datagram_datagram_get_mss_no_saved_transport_params
case_test_case "datagram_get_mss_saved_transport_params" --id legacy --mode self-reporting --run case_transport_datagram_datagram_get_mss_saved_transport_params
case_test_case "datagram_mss_limited_by_MTU" --id legacy --mode self-reporting --run case_transport_datagram_datagram_mss_limited_by_MTU
case_test_case "timer_based_dgram_probe" --id legacy --mode self-reporting --run case_transport_datagram_timer_based_dgram_probe
case_test_case "datagram_mss_limited_by_max_datagram_frame_size" --id legacy --mode self-reporting --run case_transport_datagram_datagram_mss_limited_by_max_datagram_frame_size
case_test_case "send_0RTT_datagram_100KB" --id legacy --mode self-reporting --run case_transport_datagram_send_0RTT_datagram_100KB
case_test_case "send_0RTT_datagram_100KB_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_0RTT_datagram_100KB_batch
case_test_case "send_1RTT_datagram_100KB" --id legacy --mode self-reporting --run case_transport_datagram_send_1RTT_datagram_100KB
case_test_case "send_1RTT_datagram_100KB_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_1RTT_datagram_100KB_batch
case_test_case "send_0rtt_datagram_without_saved_datagram_tp" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_datagram_without_saved_datagram_tp
case_test_case "send_0rtt_datagram_without_saved_datagram_tp_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_datagram_without_saved_datagram_tp_batch
case_test_case "send_too_many_0rtt_datagrams" --id legacy --mode self-reporting --run case_transport_datagram_send_too_many_0rtt_datagrams
case_test_case "send_too_many_0rtt_datagrams_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_too_many_0rtt_datagrams_batch
case_test_case "send_0rtt_datagram_reject" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_datagram_reject
case_test_case "send_oversized_datagram" --id legacy --mode self-reporting --run case_transport_datagram_send_oversized_datagram
case_test_case "send_oversized_datagram_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_oversized_datagram_batch
case_test_case "send_datagram_while_peer_does_not_support" --id legacy --mode self-reporting --run case_transport_datagram_send_datagram_while_peer_does_not_support
case_test_case "send_datagram_batch_while_peer_does_not_support" --id legacy --mode self-reporting --run case_transport_datagram_send_datagram_batch_while_peer_does_not_support
case_test_case "send_0rtt_datagram_dgram1_lost" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_datagram_dgram1_lost
case_test_case "send_1rtt_datagram_dgram1_lost" --id legacy --mode self-reporting --run case_transport_datagram_send_1rtt_datagram_dgram1_lost
case_test_case "send_0rtt_datagram_reorder" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_datagram_reorder
case_test_case "send_1rtt_datagram_reorder" --id legacy --mode self-reporting --run case_transport_datagram_send_1rtt_datagram_reorder
case_test_case "datagram_lost_callback" --id legacy --mode self-reporting --run case_transport_datagram_datagram_lost_callback
case_test_case "datagram_acked_callback" --id legacy --mode self-reporting --run case_transport_datagram_datagram_acked_callback
case_test_case "1RTT_datagram_send_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__1RTT_datagram_send_redundancy
case_test_case "1RTT_datagram_send_multiple_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__1RTT_datagram_send_multiple_redundancy
case_test_case "0RTT_datagram_send_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__0RTT_datagram_send_redundancy
case_test_case "0RTT_datagram_send_multiple_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__0RTT_datagram_send_multiple_redundancy
case_test_case "stop_datagram_send_redundancy_after_negotiation" --id legacy --mode self-reporting --run case_transport_datagram_stop_datagram_send_redundancy_after_negotiation
case_test_case "send_0RTT_h3_ext_datagram_100KB" --id legacy --mode self-reporting --run case_transport_datagram_send_0RTT_h3_ext_datagram_100KB
case_test_case "send_0RTT_h3_ext_datagram_100KB_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_0RTT_h3_ext_datagram_100KB_batch
case_test_case "send_1RTT_h3_ext_datagram_100KB" --id legacy --mode self-reporting --run case_transport_datagram_send_1RTT_h3_ext_datagram_100KB
case_test_case "send_1RTT_h3_ext_datagram_100KB_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_1RTT_h3_ext_datagram_100KB_batch
case_test_case "send_0rtt_h3_ext_datagram_without_saved_datagram_tp" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_h3_ext_datagram_without_saved_datagram_tp
case_test_case "send_0rtt_h3_ext_datagram_without_saved_datagram_tp_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_h3_ext_datagram_without_saved_datagram_tp_batch
case_test_case "send_too_many_0rtt_h3_ext_datagrams" --id legacy --mode self-reporting --run case_transport_datagram_send_too_many_0rtt_h3_ext_datagrams
case_test_case "send_too_many_0rtt_h3_ext_datagrams_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_too_many_0rtt_h3_ext_datagrams_batch
case_test_case "send_0rtt_h3_ext_datagram_reject" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_h3_ext_datagram_reject
case_test_case "send_oversized_h3_ext_datagram" --id legacy --mode self-reporting --run case_transport_datagram_send_oversized_h3_ext_datagram
case_test_case "send_oversized_h3_ext_datagram_batch" --id legacy --mode self-reporting --run case_transport_datagram_send_oversized_h3_ext_datagram_batch
case_test_case "send_h3_ext_datagram_while_peer_does_not_support" --id legacy --mode self-reporting --run case_transport_datagram_send_h3_ext_datagram_while_peer_does_not_support
case_test_case "send_h3_ext_datagram_batch_while_peer_does_not_support" --id legacy --mode self-reporting --run case_transport_datagram_send_h3_ext_datagram_batch_while_peer_does_not_support
case_test_case "send_0rtt_h3_ext_datagram_dgram1_lost" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_h3_ext_datagram_dgram1_lost
case_test_case "send_1rtt_h3_ext_datagram_dgram1_lost" --id legacy --mode self-reporting --run case_transport_datagram_send_1rtt_h3_ext_datagram_dgram1_lost
case_test_case "send_0rtt_h3_ext_datagram_reorder" --id legacy --mode self-reporting --run case_transport_datagram_send_0rtt_h3_ext_datagram_reorder
case_test_case "send_1rtt_h3_ext_datagram_reorder" --id legacy --mode self-reporting --run case_transport_datagram_send_1rtt_h3_ext_datagram_reorder
case_test_case "1RTT_h3_ext_datagram_send_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__1RTT_h3_ext_datagram_send_redundancy
case_test_case "1RTT_h3_ext_datagram_send_multiple_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__1RTT_h3_ext_datagram_send_multiple_redundancy
case_test_case "0RTT_h3_ext_datagram_send_redundancy" --id legacy --mode self-reporting --run case_transport_datagram__0RTT_h3_ext_datagram_send_redundancy
...
case_test_case "SP_h3_ext_datagram_PMTUD_0RTT" --id legacy --mode self-reporting --run case_transport_datagram_SP_h3_ext_datagram_PMTUD_0RTT
