...
xqc_demo_cli_usage(int argc, char *argv[])
{
    ...
    printf(
        ...
        "   -g    Print received WebTransport stream and datagram data.\n"
        "   -H L  Send L bytes of 'd' on a draft-16 bidirectional stream.\n"
    ...
    xqc_demo_cli_client_args_t *args)
{
        ...
        "n:e:E:F:G:r:x:y:Y:f:z:q65OWv:j:J:X:gH:")) != -1)
    {
        ...
        case 'H': {
            ...
            {
                fprintf(stderr,
                        "WT payload length must be a positive integer\n");
                return -1;
            }
