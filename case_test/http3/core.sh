...
case_test_case "header_data_fin" --id native --mode self-reporting --run case_http3_core_header_data_fin
case_test_case "header_data_immediate_fin" --id native --mode self-reporting --run case_http3_core_header_data_immediate_fin
case_test_case "header_fin" --id native --mode self-reporting --run case_http3_core_header_fin
case_test_case "uppercase_header" --id native --mode self-reporting --run case_http3_core_uppercase_header
case_test_case "forbidden_header_e2e" --id native --mode self-reporting --run case_http3_core_forbidden_header_e2e
case_test_case "h3_ping" --id native --mode self-reporting --run case_http3_core_h3_ping
case_test_case "empty_header_value" --id native --mode self-reporting --run case_http3_core_empty_header_value
case_test_case "GET_request" --id native --mode self-reporting --run case_http3_core_GET_request
case_test_case "set_h3_settings" --id native --mode self-reporting --run case_http3_core_set_h3_settings
case_test_case "header_size_constraints" --id native --mode self-reporting --run case_http3_core_header_size_constraints
case_test_case "no_h3_init_settings_cb" --id native --mode self-reporting --run case_http3_core_no_h3_init_settings_cb
case_test_case "set_h3_init_settings_cb" --id native --mode self-reporting --run case_http3_core_set_h3_init_settings_cb
case_test_case "test_client_long_header" --id native --mode self-reporting --run case_http3_core_test_client_long_header
case_test_case "test_server_long_header" --id native --mode self-reporting --run case_http3_core_test_server_long_header
case_test_case "massive_requests_with_massive_header" --id native --mode self-reporting --run case_http3_core_massive_requests_with_massive_header
case_test_case "h3_MP_ping" --id native --mode self-reporting --run case_http3_core_h3_MP_ping
case_test_case "h3_engine_set_settings_api_h3" --id native --mode self-reporting --run case_http3_core_h3_engine_set_settings_api_h3
case_test_case "h3_engine_set_settings_api_h3_more" --id native --mode self-reporting --run case_http3_core_h3_engine_set_settings_api_h3_more
case_test_case "h3_engine_set_settings_api_h3_29" --id native --mode self-reporting --run case_http3_core_h3_engine_set_settings_api_h3_29
case_test_case "h3_engine_set_settings_api_h3_29_more" --id native --mode self-reporting --run case_http3_core_h3_engine_set_settings_api_h3_29_more
case_test_case "h3_engine_set_settings_api_h3_ext" --id native --mode self-reporting --run case_http3_core_h3_engine_set_settings_api_h3_ext
case_test_case "h3_engine_set_settings_api_h3_ext_more" --id native --mode self-reporting --run case_http3_core_h3_engine_set_settings_api_h3_ext_more
