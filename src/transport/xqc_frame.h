...
/*
 * Bitmask type for frame types.  Use uint64_t instead of enum to
 * avoid overflow on compilers where enum is 32-bit (e.g. MSVC),
 * since XQC_FRAME_NUM can exceed 31.
 */
